...
@Component({
  selector: 'app-member-detail-reactive-popup',
  templateUrl: './member-detail-reactive-popup.component.html',
  styleUrls: [
    '../../../../../assets/icon/icofont/css/icofont.scss'
  ]
})
export class MemberDetailReactivePopupComponent implements OnInit, OnChanges {
